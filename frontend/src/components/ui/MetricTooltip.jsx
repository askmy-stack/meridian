 ...
 */
export function MetricTooltip({ label, definition, reference }) {
  ...
  return (
    <span className="relative inline-flex group/metric ml-1 align-middle">
      ...
      <span
        role="tooltip"
        className="pointer-events-none absolute bottom-full left-1/2 z-50 mb-2 w-64 -translate-x-1/2 rounded-xl border border-slate-600/60 bg-[#0f1629] px-3 py-2 text-left text-xs text-slate-300 opacity-0 shadow-xl transition-opacity group-hover/metric:opacity-100 group-focus-within/metric:opacity-100"
      >
